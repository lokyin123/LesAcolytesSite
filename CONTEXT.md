...
The current landing/page photograph assignments are: photo 7 for the homepage hero, 79 for About, portrait 18 for Musicians, 10 for What's On, 74 for Programmes, 54 for Media, portrait 86 for News, and portrait 92 for Contact. Labelled photographs use URL-safe filenames. Landing panels share a responsive height of `max(560px, 33.333vw)`, matching the natural 3:2 landscape ratio on wide screens; portrait images crop centrally. The Musicians and News internal page heroes use the same frame formula so their portrait photographs cannot expand the panel height and retain the same crop as their landing counterparts. Below 900px, section images stack at a 55vw height.
